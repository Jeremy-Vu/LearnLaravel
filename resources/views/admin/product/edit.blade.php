...
@section('content')
    ...
    <form action="{{ route('admin.product.update' , $each) }}" method="post" style="display: table">
        @csrf
        @method('PUT')
        <div class="form-group">
            ...
            <div style="display: table-row">
                ...
                <label>
                    <input type="number" min="0" name="price" value="{{$each->price ?? old('price') }}" class="form-control">
                    @if ($errors->has('price'))
                        <span class="error" style="color: red; font-size: 12px;">
                        {{ $errors->first('price') }}
                    </span>
            ...
            <div style="display: table-row">
                ...
                <label>
                    <input type="number" min="0" name="quantity" class="form-control" value="{{$each->quantity ?? old('quantity') }}">
            ...
            <div style="display: table-row">
                ...
                <label>
                    <textarea type="text" name="detail_product" placeholder="{{$each->detail_product ?? old('detail_product') }}"
                              class="form-control">
                    </textarea>
            ...
            <div style="display: table-row">
                ...
                <label>
                    <input type="text" name="description" value="{{$each->description ?? old('description') }}" class="form-control">
