...
@section('content')
    ...
    <form action="{{ route('admin.category.store') }}" method="post" style="display: table">
        @csrf
        <div class="form-group">
            ...
            <div style="display: table-row">
                ...
                <label>
                    <input type="text" min="0" name="slug " value="{{ old('slug ') }}" class="form-control">
                    @if ($errors->has('slug '))
                        <span class="error" style="color: red; font-size: 12px;">
                        {{ $errors->first('slug ') }}
                    </span>
            ...
            <div style="display: table-row">
                ...
                <label>
                    <input type="text" min="0" name="description" class="form-control" value="{{ old('description') }}">
            ...
            <div style="display: table-row">
                ...
                <label>
                    <textarea type="text" name="content" placeholder="{{ old('content') }}"
                              class="form-control">
                    </textarea>
            ...
            <div style="display: table-row">
                ...
                <label>
                    <input type="number" name="is_menu" value="{{ old('is_menu') }}" class="form-control">
            ...
            <div style="display: table-row">
                ...
                <label>
                    <input type="number" name="parrent_id" value="{{ old('parrent_id') }}" class="form-control">
